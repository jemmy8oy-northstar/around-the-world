import { SHOULD_AUTOBATCH, applyPatches, combineReducers, createAction, createAsyncThunk, createSelector, createSlice, current, enablePatches, isAction, isAllOf, isAnyOf, isAsyncThunkAction, isDraft, isDraftable, isFulfilled, isPending, isPlainObject, isRejected, isRejectedWithValue, nanoid, original, prepareAutoBatched, produce, produceWithPatches, weakMapMemoize } from "./redux-toolkit.modern-BKM6ZwCy.js";
...
function isAbsoluteUrl(url) {
	return (/* @__PURE__ */ new RegExp(`(^|:)//`)).test(url);
}
		...
		try {
			...
			if (isQuery && "infiniteQueryOptions" in endpointDefinition) {
				...
				if ("direction" in arg && arg.direction && existingData.pages.length) {
					...
					const param = (previous ? getPreviousPageParam : getNextPageParam)(infiniteQueryOptions, existingData, arg.originalArgs);
...
//# sourceMappingURL=rtk-query.modern-fU6KPJ5d.js.map